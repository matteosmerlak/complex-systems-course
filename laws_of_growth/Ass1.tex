...
\medskip
If your response happens to be inspired by online content, say it clearly and show us that you actually used your brain in the process. 
...
\begin{enumerate}
	\item Identify a mathematical function $m(t)$ which could plausibly represent the growth curve of a living being (i.e. its mass as a function of time from birth to death/replication) and plot it, with labelled axes, plot label, etc --- make it look nice. Explain why your choice of $m(t)$ is sensible and what approximations underlies it, if any. 
	\item  Compute within your chosen model (analytically if you can, else numerically) the time $t^*$ when the organism grows fastest, i.e. when $dm/dt$ reaches its maximum. Add this point on your plot of $m(t)$. 
	...
	\item Test this assumption with a suitable regression (e.g. from scipy.optimize import least\textunderscore squares).
	...
	\item Conclude: what is the relationship between growth and mass at maximum growth across the tree of life? Estimate the relevant parameters by a suitable fitting procedure.  
\end{enumerate}
